defmodule Squeeze.Challenges.ScoreUpdater do
  ...
  def amount(%Activity{external_id: external_id, user: user}, %Challenge{
        challenge_type: :segment,
        segment_id: segment_id
      }) do
    {:ok, strava_activity} = Strava.Activities.get_activity_by_id(user, external_id)

    best_effort =
      strava_activity.segment_efforts
