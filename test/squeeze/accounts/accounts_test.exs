defmodule Squeeze.AccountsTest do
  ...
  describe "credentials" do
    ...
    @valid_attrs %{provider: "some provider", token: "some token", uid: "some uid"}
    @update_attrs %{provider: "some updated provider", token: "some updated token", uid: "some updated uid"}
    @invalid_attrs %{provider: nil, token: nil, uid: nil}
